...
import { CombinedSchoolDataFromFirebase, SingleStudentDataFromFirebase } from "../utils/interfaces";
    ...
    useEffect(() => {
      //sprawdzanie danych
        if(school?.students) {
            ...
            if(tempError) toast.error("Nie ma ucznia o takim adresie email", { autoClose: 3000 })
        }
      // eslint-disable-next-line
    }, [school])
